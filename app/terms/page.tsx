        ...
        <section className="py-12">
          <div className="container px-4 md:px-6 max-w-4xl">
            <div className="prose prose-lg prose-blue mx-auto">
              <p>
                Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the Claro Mental
                Health website and platform (the "Service") operated by Claro Mental Health ("us", "we", or "our").
              </p>
              <p>
              ...
              <p>
                ...
                are and will remain the exclusive property of Claro Mental Health and its licensors. The Service is
                ...
                written consent of Claro Mental Health.
              </p>
              ...
              <p>
                Claro Mental Health has no control over, and assumes no responsibility for, the content, privacy
                policies, or practices of any third-party websites or services. You further acknowledge and agree that
                Claro Mental Health shall not be responsible or liable, directly or indirectly, for any damage or loss
              ...
              <p>
                In no event shall Claro Mental Health, nor its directors, employees, partners, agents, suppliers, or
              ...
              <h2>10. Contact Us</h2>
              <p>If you have any questions about these Terms, please contact us at legal@claromentalhealth.com.</p>
            </div>
          </div>
        </section>
      </main>
