              ...
              <Card className="border-calm-blue-100">
                <CardContent className="p-6">
                  <div className="grid gap-6 md:grid-cols-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-calm-blue-800 mb-4">Program Effectiveness</h3>
                      <div className="space-y-4">
                        <div>
                          <div className="flex justify-between text-sm mb-1">
                            <span className="text-calm-blue-600">Knowledge Retention</span>
                            <span className="text-green-600 font-medium">86%</span>
                          </div>
                          <Progress value={86} className="h-2" />
                        </div>
                        <div>
                          <div className="flex justify-between text-sm mb-1">
                            <span className="text-calm-blue-600">Behavior Change</span>
                        ...
                        <div>
                          <div className="flex justify-between text-sm mb-1">
                            <span className="text-calm-blue-600">Satisfaction Score</span>
